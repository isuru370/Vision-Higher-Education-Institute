...
<body>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <div class="subtitle">Institute Date Range Report</div>
                </td>
                <td class="meta">
                    <div><strong>From:</strong> {{ $report['start_date'] ?? '-' }}</div>
                    <div><strong>To:</strong> {{ $report['end_date'] ?? '-' }}</div>
                    <div><strong>Generated:</strong> {{ date('Y-m-d') }}</div>
                    <div><strong>Type:</strong> Date Range</div>
                </td>
            </tr>
        </table>
    </div>
        ...
        <div class="teacher-block">
            ...
            <table>
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center">No class-wise data available</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    @empty
        <table>
            <tr>
                <td class="text-center">No teacher data available for this period.</td>
            </tr>
        </table>
    @endforelse
